...
export function environment3init() {
    ...
    // ---- 1. Cargo Staging Bay ----
    const zone1 = makeFloor(60, 0x555555);
    for (let i = 0; i < 4; i++) {
    ...
    const zone4 = makeFloor(70, 0x222244);
    for (let i = -1; i <= 1; i++) {
        ...
        puddle.position.set(i * 6, 70.01, zone4.z - zoneLength / 3);
    ...
    const zone6 = makeFloor(40, 0x666666);
    const light = new THREE.DirectionalLight(0xffddaa, 5);
    light.position.set(-20, 60, zone6.z + zoneLength / 2);
